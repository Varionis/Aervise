...
from core import DecisionLayer2Evaluator, DecisionLayer3Policy, DecisionLayer4Explainer


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate Aervise decision engine layer 4 explanation output.")
...
def main() -> int:
    ...
    rendered = json.dumps(layer4, indent=2)
    if args.output:
