...
from core import DecisionLayer2Evaluator


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate Aervise decision engine layer 2 risk factors.")
...
def main() -> int:
    ...
    rendered = json.dumps(layer2, indent=2)
    if args.output:
